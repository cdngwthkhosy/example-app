...
<div class="page-header d-print-none">
  <div class="container-xl">
    <div class="row g-2 align-items-center">
      <div class="col">
        <h3 class="page-pretitle text-success">Report</h3>
        <h2 class="page-title">
          Mutabaah
        </h2>
      </div>
        ...
        <div class="card-body">
          <form action="" method="get">
            <div class="row mb-4">
              <div class="col-md-3">
                @csrf
                <input type="month" class="form-control" name="date_filter">
              </div>
              <div class="col-md-3">
          ...
          <div class="row mb-4 justify-content-center">
            <div class="col-md-2">
              <div class="card bg-indigo text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Sholat Subuh</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-yellow text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Sholat Dzuhur</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-orange text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Sholat Ashar</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-purple text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Sholat Maghrib</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-primary text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Sholat Isya</h5>
          ...
          <div class="row mb-4 justify-content-center">
            <div class="col-md-2">
              <div class="card bg-indigo text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Qobla Subuh</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-yellow text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Qobla Dzuhur</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-yellow text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Bada Dzuhur</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-purple text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Bada Maghrib</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-primary text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Bada Isya</h5>
          ...
          <div class="row mb-4 justify-content-center">
            <div class="col-md-2">
              <div class="card bg-indigo text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Tahajud</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-indigo text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Witir</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-yellow text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Dhuha</h5>
          ...
          <div class="row mb-4 justify-content-center">
            <div class="col-md-2">
              <div class="card bg-indigo text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Al-Matsurat</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-cyan text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Tilawah Quran</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-dark text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Baca Terjemahan Quran</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-yellow text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Tahfizh Quran</h5>
          ...
          <div class="row mb-4 justify-content-center">
            <div class="col-md-2">
              <div class="card bg-lime text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Shaum Sunnah</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-success text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Infaq</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-teal text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Baca Buku</h5>
            ...
            <div class="col-md-2">
              <div class="card bg-orange text-primary-fg">
                ...
                <div class="card-body text-white">
                  <h5 class="card-title">Nilai Kajian Keilmuan</h5>
